...
export default {
    ...
    methods: {
        // TODO 加载cesium地球
        init() {
            // 提供一个token去访问Bing影像底图
            Cesium.Ion.defaultAccessToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiI2YWVkY2UzNC05OTQxLTQyMmYtYThlMS1hODYyNjg0NTE1ODgiLCJpZCI6MzEyNjYsInNjb3BlcyI6WyJhc3IiLCJnYyJdLCJpYXQiOjE1OTUxNTg1OTN9.m1A36I9Ap30CrF_gmbI1qOqOtvlkdhgKkvsqW-hEkNg';
            ...
            const entity2 = new Cesium.Entity({
                ...
                model: {
                    uri: '/static/police/Cesium_Ground.gltf',
                    scale: 10000,
                },
            });
            ...
            viewer.zoomTo(viewer.entities);
            // console.log(viewer.entities.getById('entity1'));
            viewer.entities.remove(entity1);
            // viewer.screenSpaceEventHandler.setInputAction((ss, mm) => {
            //     console.log(ss, mm);
            // }, Cesium.ScreenSpaceEventType.LEFT_CLICK);

            // viewer.entities.collectionChanged.addEventListener((ss) => {
            //     console.log(ss);
            // }, Cesium.ScreenSpaceEventType.LEFT_CLICK);
            ...
            handler.setInputAction((click) => {
                ...
                if (pick && pick.primitive) {
                    console.log(pick.primitive instanceof Cesium.Model);
                }
            }, Cesium.ScreenSpaceEventType.LEFT_CLICK);
        },
        // 基本类型新建查询删除操作
